...
admin.site.register(AchievementBlock)
admin.site.register(UploadVideo)
admin.site.register(PracticeAreas)
admin.site.register(LawyerCard)
admin.site.register(VashePravoImg)
admin.site.register(Reviews)
admin.site.register(Gallery)
admin.site.register(FooterNumber)
